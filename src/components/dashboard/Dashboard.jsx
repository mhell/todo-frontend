...
const Dashboard = () => {
  ...
  const recentTasks = sortedTasks.filter((task) => new Date(task.dueDate) >= today);

  const overdueTasks = sortedTasks.filter((task) => new Date(task.dueDate) < today && task.status !== "completed");
      ...
      <main className="dashboard-main">
        ...
        <div className="dashboard-content">
          ...
          <div className="tasks-grid">
            <TaskTable tasks={recentTasks} title="Recent Tasks" isOverdue={false} />
            <TaskTable tasks={overdueTasks} title="Overdue Tasks" isOverdue={true} />
          </div>
        </div>
      </main>
    </div>
